...
var baseTemplate = require("../../../../frontend/src/assets/template_types/base.json");

var createdTypeAvers = {
  fieldText: ["ح", "لا إله إلا الله", "بويه"],
  innerInscript: ["خمس وستين وثلثمائة"],
  intermediateInscript: ["اَنَا اللّٰہُ اَعلَمُ: میں اللہ", "اہل روم مغل گئے۔"],
  outerInscript: ["Koran 30:4‒5", "قریب کی زمین میں۔ے۔", "تبھی اور"],
  misc: ["Stern in Mitte", "ب کئے گئے۔"]
};
var createdTypeReverse = {
  fieldText: ["لله", "محمد رسول الله"],
  innerInscript: ["محمد رسول + Koran 9:33", "اللہ کے نام کے"],
  intermediateInscript: ["عذاب آ جائے۔", "اپنی قوم کو ڈرا - Koran 71:1"],
  outerInscript: ["اُس نے کہا۔", "second row"],
  misc: ["He said, ‘O my people!"]
};

function linesToDefaultFormattedText(arr) {
  return arr.map(function (val) {
    return "<div style=\"text-align: center;\">".concat(val, "</div>");
  }).join("");
}
...
function _default() {
  ...
  //                 return arr
  //             })
  //             .should('deep.eq', ["Fārs365Ga", "Fārs365Gb"])
  //     })
  // })
