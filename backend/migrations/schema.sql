...
ALTER TABLE
    public.app_user_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.coin_marks OWNER TO rukn;

--
-- Name: coin_marks_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.coin_marks_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.coin_marks_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.dynasty OWNER TO rukn;

--
-- Name: dynasty_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.dynasty_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.dynasty_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.honorific OWNER TO rukn;

--
-- Name: honorific_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.honorific_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.honorific_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.issuer OWNER TO rukn;

--
-- Name: issuer_honorifics; Type: TABLE; Schema: public; Owner: rukn
--
CREATE TABLE public.issuer_honorifics (issuer integer, honorific integer);

ALTER TABLE
    public.issuer_honorifics OWNER TO rukn;

--
-- Name: issuer_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.issuer_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.issuer_id_seq OWNER TO rukn;
...
--
CREATE TABLE public.issuer_titles (issuer integer, title integer);

ALTER TABLE
    public.issuer_titles OWNER TO rukn;
...
ALTER TABLE
    public.material OWNER TO rukn;

--
-- Name: material_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.material_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.material_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.mint OWNER TO rukn;

--
-- Name: mint_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.mint_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.mint_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.nominal OWNER TO rukn;

--
-- Name: nominal_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.nominal_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.nominal_id_seq OWNER TO rukn;
...
--
CREATE TABLE public.other_person (type integer, person integer);

ALTER TABLE
    public.other_person OWNER TO rukn;
...
ALTER TABLE
    public.overlord_honorifics OWNER TO rukn;

--
-- Name: overlord_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.overlord_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.overlord_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.overlord_titles OWNER TO rukn;
...
ALTER TABLE
    public.person OWNER TO rukn;

--
-- Name: person_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.person_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.person_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.person_role OWNER TO rukn;

--
-- Name: person_role_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.person_role_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.person_role_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.piece OWNER TO rukn;

--
-- Name: piece_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.piece_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.piece_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.title OWNER TO rukn;

--
-- Name: title_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.title_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.title_id_seq OWNER TO rukn;
...
ALTER TABLE
    public.type OWNER TO rukn;

--
-- Name: type_coin_marks; Type: TABLE; Schema: public; Owner: rukn
--
CREATE TABLE public.type_coin_marks (type integer, coin_mark integer);

ALTER TABLE
    public.type_coin_marks OWNER TO rukn;

--
-- Name: type_completed; Type: TABLE; Schema: public; Owner: rukn
--
CREATE TABLE public.type_completed (type integer NOT NULL);

ALTER TABLE
    public.type_completed OWNER TO rukn;

--
-- Name: type_id_seq; Type: SEQUENCE; Schema: public; Owner: rukn
--
CREATE SEQUENCE public.type_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER TABLE
    public.type_id_seq OWNER TO rukn;
...
--
CREATE TABLE public.type_reviewed (type integer NOT NULL);

ALTER TABLE
    public.type_reviewed OWNER TO rukn;

--
-- Name: app_user id; Type: DEFAULT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.app_user
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.app_user_id_seq' :: regclass);

--
-- Name: coin_marks id; Type: DEFAULT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.coin_marks
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.coin_marks_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.dynasty_id_seq' :: regclass);

--
-- Name: honorific id; Type: DEFAULT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.honorific
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.honorific_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.issuer_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.material_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.mint_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.nominal_id_seq' :: regclass);

--
-- Name: overlord id; Type: DEFAULT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.overlord
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.overlord_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.person_id_seq' :: regclass);

--
-- Name: person_role id; Type: DEFAULT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.person_role
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.person_role_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.piece_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.title_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.type_id_seq' :: regclass);
...
ALTER TABLE
    ONLY public.coin_marks
ADD
    CONSTRAINT coin_marks_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.dynasty
ADD
    CONSTRAINT dynasty_name_key UNIQUE (name);
...
ALTER TABLE
    ONLY public.honorific
ADD
    CONSTRAINT honorific_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.nominal
ADD
    CONSTRAINT nominal_pkey PRIMARY KEY (id);
...
--
ALTER TABLE
    ONLY public.type_completed
ADD
    CONSTRAINT type_completed_type_key UNIQUE (type);
...
ALTER TABLE
    ONLY public.type
ADD
    CONSTRAINT type_project_id_key UNIQUE (project_id);

--
-- Name: type_reviewed type_reviewed_type_key; Type: CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.type_reviewed
ADD
    CONSTRAINT type_reviewed_type_key UNIQUE (type);

--
-- Name: type_coin_marks cmt_coin_mark_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.type_coin_marks
ADD
    CONSTRAINT cmt_coin_mark_fk FOREIGN KEY (coin_mark) REFERENCES public.coin_marks(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type_coin_marks
ADD
    CONSTRAINT cmt_type_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: issuer_honorifics ih_honorific_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.issuer_honorifics
ADD
    CONSTRAINT ih_honorific_fk FOREIGN KEY (honorific) REFERENCES public.honorific(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.issuer_honorifics
ADD
    CONSTRAINT ih_issuer_fk FOREIGN KEY (issuer) REFERENCES public.issuer(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.issuer
ADD
    CONSTRAINT issuer_person_fk FOREIGN KEY (person) REFERENCES public.person(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.issuer
ADD
    CONSTRAINT issuer_type_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: issuer_titles it_issuer_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.issuer_titles
ADD
    CONSTRAINT it_issuer_fk FOREIGN KEY (issuer) REFERENCES public.issuer(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.issuer_titles
ADD
    CONSTRAINT it_title_fk FOREIGN KEY (title) REFERENCES public.title(id) ON UPDATE CASCADE ON DELETE RESTRICT;

--
-- Name: overlord_honorifics oh_honorific_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.overlord_honorifics
ADD
    CONSTRAINT oh_honorific_fk FOREIGN KEY (honorific_id) REFERENCES public.honorific(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.overlord_honorifics
ADD
    CONSTRAINT oh_overlord_fk FOREIGN KEY (overlord_id) REFERENCES public.overlord(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: other_person other_person_person_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.other_person
ADD
    CONSTRAINT other_person_person_fk FOREIGN KEY (person) REFERENCES public.person(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.other_person
ADD
    CONSTRAINT other_person_type_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;

--
-- Name: overlord_titles overlord_honorific_fk; Type: FK CONSTRAINT; Schema: public; Owner: rukn
--
ALTER TABLE
    ONLY public.overlord_titles
ADD
    CONSTRAINT overlord_honorific_fk FOREIGN KEY (title_id) REFERENCES public.title(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.overlord
ADD
    CONSTRAINT overlord_person_fk FOREIGN KEY (person) REFERENCES public.person(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.overlord_titles
ADD
    CONSTRAINT overlord_title_fk FOREIGN KEY (overlord_id) REFERENCES public.overlord(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.overlord
ADD
    CONSTRAINT overlord_type_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.person
ADD
    CONSTRAINT person_dynasty_fk FOREIGN KEY (dynasty) REFERENCES public.dynasty(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.person
ADD
    CONSTRAINT person_role_fk FOREIGN KEY (role) REFERENCES public.person_role(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.piece
ADD
    CONSTRAINT piece_type_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.type_completed
ADD
    CONSTRAINT type_completed_type_id_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.type
ADD
    CONSTRAINT type_material_fk FOREIGN KEY (material) REFERENCES public.material(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type
ADD
    CONSTRAINT type_mint_fk FOREIGN KEY (mint) REFERENCES public.mint(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type
ADD
    CONSTRAINT type_nominal_fk FOREIGN KEY (nominal) REFERENCES public.nominal(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type
ADD
    CONSTRAINT type_person_caliph_fk FOREIGN KEY (caliph) REFERENCES public.person(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE
    ONLY public.type_reviewed
ADD
    CONSTRAINT type_reviewed_type_id_fk FOREIGN KEY (type) REFERENCES public.type(id) ON UPDATE CASCADE ON DELETE CASCADE;
